...
{ 
    ...
    public class SimpleInletScaleObject : MonoBehaviour
    {
        ...
        double default_sampling_rate = 1000; // in case inlet does not have a sampling rate
        ...
        IEnumerator ResolveExpectedStream()
        {
            ...
            {
                Debug.Log("Resolving stream name [" + StreamName + "]");
            ...
            int buf_samples = (int)Mathf.Ceil((float)(sampling_rate * max_chunk_duration));
        ...
        void FixedUpdate()
        {
            if (inlet != null)
            {
                ...
                if (samples_returned > 0)
                {
                    ...
                    var new_position = new Vector3(x, 0, 0);
